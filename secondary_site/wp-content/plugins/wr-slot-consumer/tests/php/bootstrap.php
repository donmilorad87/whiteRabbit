<?php
/**
 * PHPUnit bootstrap for WR Slot Consumer standalone tests.
 * Loads only the autoloader, not WordPress or the full plugin init.
 */

define( 'ABSPATH', '/tmp/fake-wp/' );
define( 'WR_SC_PLUGIN_FILE', dirname( __DIR__, 2 ) . '/wr-slot-consumer.php' );
define( 'WR_SC_PLUGIN_DIR', dirname( __DIR__, 2 ) . '/' );
define( 'WR_SC_PLUGIN_URL', 'http://localhost/wp-content/plugins/wr-slot-consumer/' );
define( 'WR_SC_OPTION_PREFIX', 'wr_sc_' );
define( 'WR_SC_CACHE_EXPIRY', 3600 );
...
spl_autoload_register(
	function ( $class ) {
		$prefix   = 'WiseRabbit\\SlotConsumer\\';
