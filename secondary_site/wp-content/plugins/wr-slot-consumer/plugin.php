<?php
/**
 * Plugin initialization: autoloader, i18n, and bootstrap.
 *
 ...
 *
 * WiseRabbit\SlotConsumer\Admin\SettingsPage     → includes/admin/class-settings-page.php
 * WiseRabbit\SlotConsumer\Traits\LoggerTrait     → includes/traits/trait-logger.php
 */
